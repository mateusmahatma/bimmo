<div class="modal fade" id="notesModal" tabindex="-1" aria-labelledby="notesModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px; overflow: hidden;">
            <div class="modal-header border-0 bg-light py-4 px-4 align-items-center">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold text-dark mb-0" id="notesModalLabel">{{ __('Personal Reminders') }}</h5>
            ...
            <div class="modal-body p-4 bg-white">
                ...
                <div class="mb-4">
                    <div class="input-group shadow-sm rounded-pill overflow-hidden border">
                        <input type="text" id="newNoteContent" class="form-control border-0 px-4 py-2" placeholder="{{ __('What needs to be done?') }}" style="box-shadow: none;">
            ...
            <div class="modal-footer border-0 bg-light py-3 px-4 justify-content-between">
