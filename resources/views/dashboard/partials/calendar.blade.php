<div class="card">
    <div class="card-header border-bottom py-3 d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div class="card-body">
            <h5 class="card-title mb-0 fw-bold" style="font-size: 1.1rem; letter-spacing: -0.01em;">
                Activity Calendar
            </h5>
            <p class="text-muted small mb-0 mt-1 d-none d-sm-block" style="font-size: 0.85rem;">Manage your schedules and
                financial deadlines.</p>
        </div>
        <div
            class="d-flex gap-2 align-items-center flex-grow-1 flex-sm-grow-0 justify-content-end header-actions-container">
            <div
                class="input-group input-group-sm overflow-hidden border border-secondary border-opacity-25 search-input-group">
            ...
            <button class="btn btn-sm btn-primary px-3 flex-shrink-0" id="btnNewEvent">
                <i class="bi bi-plus-lg me-1"></i> <span class="d-none d-md-inline">New Event</span><span
    ...
    <div class="card-body p-2 p-md-4">
        <div class="row mb-3 g-2">
            <div class="col-12 d-flex flex-wrap gap-2 justify-content-start overflow-auto pb-1 calendar-filters"
                ...
                <div class="form-check form-check-inline me-0">
                    <input class="form-check-input filter-category" type="checkbox" id="cat-reminder" value="reminder"
                        checked>
                    <label class="form-check-label small" for="cat-reminder"><span
                            class="badge bg-info p-1 me-1"></span>Reminder</label>
                </div>
                <div class="form-check form-check-inline me-0">
                    <input class="form-check-input filter-category" type="checkbox" id="cat-task" value="task"
                        checked>
                    <label class="form-check-label small" for="cat-task"><span
                            class="badge bg-primary p-1 me-1"></span>Task</label>
                </div>
                <div class="form-check form-check-inline me-0">
                    <input class="form-check-input filter-category" type="checkbox" id="cat-meeting" value="meeting"
                        checked>
                    <label class="form-check-label small" for="cat-meeting"><span
                            class="badge bg-warning p-1 me-1"></span>Meeting</label>
                </div>
                <div class="form-check form-check-inline me-0">
                    <input class="form-check-input filter-category" type="checkbox" id="cat-deadline" value="deadline"
                        checked>
                    <label class="form-check-label small" for="cat-deadline"><span
                            class="badge bg-danger p-1 me-1"></span>Deadline</label>
                </div>
            </div>
        </div>
        <div id="calendar" style="min-height: 400px;">
        </div>
    </div>
</div>
                ...
                <div class="modal-body p-3 p-md-4">
                    ...
                    <div class="mb-3 mb-md-4">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-2"
                            style="letter-spacing: 0.05em;">Basic Information</label>
                        <div class="mb-3">
                            <label class="form-label small fw-bold">Event Title</label>
                            <input type="text" name="title" class="form-control rounded-3 shadow-sm" required
                    ...
                    <div class="mb-3 mb-md-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <label class="form-label small fw-bold text-muted text-uppercase mb-0"
                                style="letter-spacing: 0.05em;">Schedule</label>
                    ...
                    <div class="mb-3 mb-md-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <label class="form-label small fw-bold text-muted text-uppercase mb-0"
                                style="letter-spacing: 0.05em;">Recurrence</label>
                            <div class="form-check form-switch mb-0">
                        ...
                        <div id="recurringInputs" class="row d-none g-2 g-md-3">
                            <div class="col-6 col-md-6 mt-0">
                                ...
                                <select name="rrule_freq" id="rruleFreq"
                            ...
                            <div class="col-6 col-md-6 mt-0">
                                ...
                                <input type="date" name="rrule_until" id="rruleUntil"
                                    class="form-control form-control-sm rounded-3 shadow-sm">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-0">
                        <label class="form-label small fw-bold text-muted text-uppercase mb-3"
                            style="letter-spacing: 0.05em;">Notifications</label>

                        <div class="row align-items-center mb-3">
                            <div class="col-12 col-md-6 mb-2 mb-md-0">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="send_email"
                                        id="sendEmailSwitch" checked>
                                    <label class="form-check-label small fw-bold" for="sendEmailSwitch">Email
                                        Reminder</label>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 d-none" id="emailInputContainer">
                                <input type="email" name="notification_email" id="notificationEmail"
                                    class="form-control form-control-sm rounded-3 shadow-sm"
                                    value="{{ auth()->user()->email }}" placeholder="Target email">
                            </div>
                        </div>

                        <div class="mb-0">
                            <label class="form-label small fw-bold">Description</label>
                            <textarea name="description" class="form-control rounded-3 shadow-sm" rows="2"
                                placeholder="Add some notes..."></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-top p-3">
                    <button type="button" class="btn btn-secondary px-3 px-md-4"
                        data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary px-3 px-md-4">Save</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="eventPopover" class="popover shadow-lg border-0"
    style="display: none; position: absolute; z-index: 1060; max-width: 250px; border-radius: 12px; background: var(--bs-body-bg);">
    <div class="popover-header fw-bold border-bottom p-2 d-flex justify-content-between align-items-center bg-body-tertiary"
    ...
    <div class="popover-body p-3">
        ...
        <div class="d-flex justify-content-between gap-2">
            <button class="btn btn-sm btn-outline-danger border-0 p-1" id="btnDeleteEvent"><i
