@push('css')
    <link rel="stylesheet"
        href="{{ asset('css/dashboard/anggaran.css') }}?v={{ filemtime(public_path('css/dashboard/anggaran.css')) }}">
@endpush
...
<div class="card">
    <div
        ...
        <div>
            <h5 class="card-title mb-0 fw-bold text-dark" style="font-size: 1rem;">{{ __('Budget Performance') }}</h5>
...
@push('scripts')
    ...
    <script
        src="{{ asset('js/dashboard-budget-performance.js') }}?v={{ filemtime(public_path('js/dashboard-budget-performance.js')) }}">
    </script>
@endpush
