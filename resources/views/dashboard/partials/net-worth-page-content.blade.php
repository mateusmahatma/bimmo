<div class="pagetitle mb-4">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('dashboard') }}" class="btn btn-light px-4 border" wire:navigate>
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="card overflow-hidden">
                <div
                    class="card-header border-0 pt-4 px-4 d-flex justify-content-between align-items-center net-worth-card-header">
                    <div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <span id="netWorthGrowthPercent"
                            class="badge bg-body-secondary text-dark border fw-semibold d-none"></span>
                        <button class="btn btn-sm net-worth-sync-btn" type="button" id="btnSyncNetWorth"
                            title="{{ __('Sync Data') }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 net-worth-table">
                            <thead class="table-header-strip">
                                <tr>
                                    <th class="ps-4 fw-600 py-3 border-0 text-uppercase text-secondary">
                                        {{ __('Month') }}</th>
                                    <th class="text-end fw-600 py-3 border-0 text-uppercase text-secondary">
                                        {{ __('Assets') }}</th>
                                    <th class="text-end fw-600 py-3 border-0 text-uppercase text-secondary">
                                        {{ __('Debt') }}</th>
                                    <th class="text-end pe-4 fw-600 py-3 border-0 text-uppercase text-secondary">
                                        {{ __('Net') }}</th>
                                </tr>
                            </thead>
