<div class="card shadow-none">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            <h5 class="card-title mb-0 fw-bold text-dark" style="font-size: 1rem;">{{ __('Expense Bar') }}</h5>
    ...
    <div class="card-body p-0">
        <div id="expenseBarTableContainer">
            @include('dashboard.partials.expense-bar-table', [
        ...
        <div class="px-4 py-3 border-top {{ $uiStyle === 'milenial' ? 'bg-transparent' : 'card-footer-strip' }}">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <strong id="totalPengeluaranValue" class="text-dark">Rp
                    {{ number_format((float) $totalPengeluaranBulan, 0, ',', '.') }}</strong>
            </div>
        </div>
    </div>
</div>
