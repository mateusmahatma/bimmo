<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm">
        ...
        <li>
             <!-- Update Button -->
            <a class="dropdown-item tombol-update-proses-anggaran" href="#" data-id="{{ $request->id_proses_anggaran }}">
                <i class="bi bi-arrow-repeat me-2 text-warning"></i> Update
            </a>
        </li>
        <li><hr class="dropdown-divider"></li>
        <li>
            <a class="dropdown-item tombol-del-proses-anggaran text-danger" href="#" data-id="{{ $request->id_proses_anggaran }}">
