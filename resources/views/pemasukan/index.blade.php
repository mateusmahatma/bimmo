...
@push('css')
    <style>
        ...
        @media (max-width: 768px) {
            ...
            #pemasukanTable td:nth-of-type(3):before {
                content: "{{ __('Category Name') }}";
            }

            #pemasukanTable td:nth-of-type(4):before {
                content: "{{ __('Created At') }}";
            }

            #pemasukanTable td:nth-of-type(5):before {
            ...
            #pemasukanTable td:nth-of-type(2) {
                display: none;
            }
        }
    </style>
                ...
                <div class="card">
                    <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="button" class="btn btn-primary btn-sm tombol-tambah-pemasukan"
                                style="padding: 2px 10px; font-size: 0.75rem;">
