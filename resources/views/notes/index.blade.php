                    ...
                    <div class="card-header border-bottom py-3 d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="card-title mb-0 fw-bold">
                                {{ __('Smart Reminders') }}</h5>
                            <p class="text-muted small mb-0 mt-1">
                                {{ __('Manage your tasks with rich formatting and efficiency.') }}</p>
                        </div>
                    </div>

                    <div class="card-body pt-4">
                        @include('notes.partials.reminder-form')
                        ...
                        <div class="mb-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="notesSearchInput"
                                    placeholder="{{ __('Search reminders...') }}" autocomplete="off">
                        ...
                        <div id="notesContainer" style="min-height: 200px;">
                            ...
                            <div class="mb-5">
                                <h6
                                    class="text-uppercase fw-bold text-primary small ls-1 mb-3 d-flex align-items-center gap-2">
                            ...
                            <div class="mt-4 pt-3 border-top">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <button class="btn btn-link btn-sm text-danger text-decoration-none p-0 d-none"
                ...
                <div class="modal-body text-center p-4">
                    ...
                    <div class="d-flex gap-2 justify-content-center">
                        ...
                        <button type="button" class="btn btn-danger px-4 fw-bold"
                            id="btnConfirmDelete">{{ __('Yes, Delete') }}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function applyFiltersAndRender() {
                const q = normalizeQuery(searchQuery);
                const filteredNotes = q ? allNotes.filter(n => htmlToText(n.content).toLowerCase().includes(q)) :
                    allNotes;
            ...
            async function saveNote() {
                ...
                try {
                    ...
                    if (res.success) {
                        resetForm();
                        loadNotes();
                        showToast('{{ __('Success') }}', '{{ __('Data processed successfully') }}',
                            'success');
                    }
                } catch (e) {
                    console.error(e);
                    ...
                    try {
                        ...
                        if (res.success) {
                            ...
                            showToast('{{ __('Success') }}',
                                '{{ __('Data processed successfully') }}', 'success');
                        }
                    } catch (e) {
                        console.error(e);
                    }
                ...
                container.querySelectorAll('.edit-note').forEach(btn => {
                    btn.addEventListener('click', async () => {
                        ...
                        if (note) {
                            ...
                            cancelEditBtn.classList.remove('d-none');
                            addNoteBtn.querySelector('i').classList.replace('bi-plus-lg',
                                'bi-check-lg');
                            window.scrollTo({
                                top: 0,
                                behavior: 'smooth'
                    ...
                    btn.addEventListener('click', () => {
                        ...
                        deleteAction = async () => {
                            try {
                                ...
                                loadNotes();
                                showToast('{{ __('Success') }}',
                                    '{{ __('Data processed successfully') }}',
                                    'success');
                            } catch (e) {
                                console.error(e);
                            }
                ...
                container.querySelectorAll('.pin-note').forEach(btn => {
                    btn.addEventListener('click', async () => {
                        ...
                        try {
                            ...
                            loadNotes();
                            showToast('{{ __('Success') }}', currentlyPinned ?
                                '{{ __('Unpinned') }}' : '{{ __('Pinned') }}', 'success');
                        } catch (e) {
                            console.error(e);
                        }
                    });
