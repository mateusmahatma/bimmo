...
<nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
    <a class="navbar-brand" href="#">Edit Data Dana Darurat</a>
</nav>
        ...
        <form action="{{ route('dana-darurat.update', $dana->id_dana_darurat) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="jenis_transaksi_dana_darurat" class="form-control">
                    <option value="1" {{ old('status', $dana->status) == '1' ? 'selected' : '' }}>Masuk</option>
                    <option value="2" {{ old('status', $dana->status) == '2' ? 'selected' : '' }}>Keluar</option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="keterangan" placeholder="Keterangan">{{ old('keterangan', $dana->keterangan)}}</textarea>
            </div>
