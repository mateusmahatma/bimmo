...
<div class="pagetitle mb-4">
    <h1 class="fw-bold mb-1">Emergency Fund</h1>
    <nav>
             ...
             <div class="card card-summary mb-4 shadow-sm">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
                        <div>
                            <h5 class="card-title mb-1 fw-bold text-dark" style="font-size: 1.1rem;">Total Emergency Fund</h5>
                            <p class="text-muted small mb-0">Prepared funds for your unexpected financial needs.</p>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="mt-2 pt-3 border-top">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <small class="text-muted italic small text-end">Balanced for your security</small>
                        </div>
                    </div>
                </div>
            </div>
