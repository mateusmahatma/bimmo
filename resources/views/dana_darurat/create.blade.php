...
@section('title', 'Add Emergency Fund')
...
<div class="pagetitle mb-4">
    <h1 class="fw-bold mb-1">Add Emergency Fund</h1>
    <nav>
        ...
        <div class="col-lg-8">
            <div class="card card-dashboard border-0 shadow-sm" style="border-radius: 12px;">
                <div class="card-header bg-white border-bottom py-3">
                    <h5 class="card-title mb-0 fw-bold text-dark" style="font-size: 1.1rem;">Add Emergency Fund Data</h5>
                    <p class="text-muted small mb-0 mt-1">Fill in the details for your emergency fund transaction.</p>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('dana-darurat.store') }}" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <select name="jenis_transaksi_dana_darurat" id="jenis_transaksi_dana_darurat" class="form-select form-select-lg" required>
                                    ...
                                    <option value="1" {{ old('jenis_transaksi_dana_darurat') == '1' ? 'selected' : '' }}>Deposit</option>
                                    <option value="2" {{ old('jenis_transaksi_dana_darurat') == '2' ? 'selected' : '' }}>Withdrawal</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="keterangan" id="keterangan" rows="3" placeholder="Add a note..."></textarea>
                        </div>

                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            <a href="{{ route('dana-darurat.index') }}" class="btn btn-light btn-lg px-4 rounded-pill">Cancel</a>
                            <button type="submit" class="btn btn-primary btn-lg px-5 rounded-pill shadow-sm">
                                <i class="bi bi-check-lg me-2"></i> Save Data
                            </button>
                        </div>
                    </form>
                </div>
