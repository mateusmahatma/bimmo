...
@section('title', __('Add New Budget'))
...
<div class="pagetitle mb-4">
    <h1 class="fw-bold mb-1">{{ __('Add New Budget') }}</h1>
    <nav>
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card-dashboard">
                <div class="card-body p-4">
                    <h5 class="card-title fw-bold mb-4">{{ __('Budget Details') }}</h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('persentase_anggaran') is-invalid @enderror" id="persentase_anggaran" name="persentase_anggaran" value="{{ old('persentase_anggaran') }}" placeholder="{{ __('e.g., 20') }}" min="0" max="100" step="0.01" required>
                            ...
                            <div class="col-12 mt-4 d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary px-4">
                                    <i class="bi bi-save me-1"></i> {{ __('Save Budget') }}
                                </button>
                            </div>
                        </div>
                    </form>
