...
@push('css')
    <style>
        ...
        @media (max-width: 768px) {
            ...
            #pengeluaranTable td:nth-of-type(3):before {
                content: "{{ __('Category Name') }}";
            }

            #pengeluaranTable td:nth-of-type(4):before {
                content: "{{ __('Created At') }}";
            }

            #pengeluaranTable td:nth-of-type(5):before {
                content: "{{ __('Last Updated') }}";
            }
            ...
            #pengeluaranTable td:nth-of-type(2) {
                display: none;
            }
        }
    </style>
                    ...
                    <div
                        ...
                        <div class="card-body">
                            <h5 class="card-title mb-0 fw-bold text-dark"
                                style="font-size: 1.1rem; letter-spacing: -0.01em;">{{ __('List of Expense') }}</h5>
                        ...
                        <div class="d-flex gap-2">
                            <div class="search-container position-relative">
                                ...
                                <input type="text" id="searchPengeluaran" class="form-control form-control-sm ps-5"
                            ...
                            <button type="button" class="btn btn-primary btn-sm tombol-tambah-pengeluaran"
                                style="padding: 2px 10px; font-size: 0.75rem;">
