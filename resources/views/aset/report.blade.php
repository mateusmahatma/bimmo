        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card info-card sales-card">
                    <div class="card-body">
                        <h5 class="card-title">{{ __('Total Assets') }} <span class="text-muted small">|
                                {{ __('Active') }}</span></h5>
            ...
            <div class="col-md-4">
                <div class="card info-card customers-card">
                    <div class="card-body">
                        <h5 class="card-title">{{ __('Total Book Value') }} <span class="text-muted small">|
                                {{ __('Current') }}</span></h5>
                        <div class="d-flex align-items-center">
                            <div
                                ...
                                <tbody>
                                    ...
                                    @forelse($recentLogs as $log)
                                        <tr>
                                            ...
                                            <td>{{ $log->kegiatan }}</td>
                                            <td class="text-end px-3 fw-bold text-danger">Rp
                                                {{ number_format($log->biaya, 0, ',', '.') }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center py-4 text-muted">
                                                {{ __('No maintenance records yet.') }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
