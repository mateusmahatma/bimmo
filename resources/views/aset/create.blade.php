                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('aset.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">{{ __('Asset Code') }} <small
                                            class="text-muted">({{ __('Optional - Leave AUTO to generate') }})</small></label>
                                    <input type="text" name="kode_aset" class="form-control"
                                        value="{{ old('kode_aset', 'AUTO') }}" placeholder="AUTO">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">{{ __('Asset Name') }} <span
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="kategori" class="form-select" required>
                                        ...
                                        <option value="Kendaraan" {{ old('kategori') == 'Kendaraan' ? 'selected' : '' }}>
                                            {{ __('Vehicle') }}</option>
                                        <option value="Furnitur" {{ old('kategori') == 'Furnitur' ? 'selected' : '' }}>
                                            {{ __('Furniture') }}</option>
                                        <option value="Elektronik" {{ old('kategori') == 'Elektronik' ? 'selected' : '' }}>
                                            {{ __('Electronic') }}</option>
                                        <option value="Investasi / Emas"
                                            {{ old('kategori') == 'Investasi / Emas' ? 'selected' : '' }}>
                                            {{ __('Investment / Gold') }}</option>
                                        <option value="Lainnya" {{ old('kategori') == 'Lainnya' ? 'selected' : '' }}>
                                            {{ __('Others') }}</option>
                                    </select>
                                </div>
                                <div class="col-md-4" id="berat_container" style="display: none;">
                                    <label class="form-label fw-bold">{{ __('Weight (Grams)') }} <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label fw-bold">{{ __('Purchase Date') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="date" name="tanggal_pembelian" class="form-control"
                                        value="{{ old('tanggal_pembelian', date('Y-m-d')) }}" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-bold">{{ __('Purchase Price') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                ...
                                <div class="col-md-4" id="masa_pakai_container">
                                    <label class="form-label fw-bold">{{ __('Useful Life (Years)') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="number" name="masa_pakai" id="masa_pakai" class="form-control"
                                        value="{{ old('masa_pakai', 5) }}" required>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label fw-bold">{{ __('Condition') }} <span
                                            class="text-danger">*</span></label>
                                    <select name="kondisi" class="form-select" required>
                                        <option value="Baik" {{ old('kondisi') == 'Baik' ? 'selected' : '' }}>
                                            {{ __('Good') }}</option>
                                        <option value="Kurang Baik"
                                            {{ old('kondisi') == 'Kurang Baik' ? 'selected' : '' }}>{{ __('Fair') }}
                                        </option>
                                        <option value="Rusak Berat"
                                            {{ old('kondisi') == 'Rusak Berat' ? 'selected' : '' }}>{{ __('Bad') }}
                                        </option>
                            ...
                            <div class="mt-4 d-flex justify-content-end gap-2">
                                <a href="{{ route('aset.index') }}" class="btn btn-light px-4">{{ __('Cancel') }}</a>
                                <button type="submit" class="btn btn-primary px-4">{{ __('Save Asset') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
