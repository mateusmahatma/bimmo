...
@section('container')
    ...
    <section class="section dashboard transaksi-page">
        <div class="row">
                ...
                <div class="card h-100 d-flex flex-column justify-content-center">
                    <div class="card-body py-4">
                        <div class="d-flex align-items-center mb-2">
                            <div
                                class="card-icon transaksi-card-icon transaksi-card-icon--success
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 d-flex flex-column justify-content-center">
                    <div class="card-body py-4">
                        <div class="d-flex align-items-center mb-2">
                            <div
                                class="card-icon transaksi-card-icon transaksi-card-icon--danger
                                        rounded-circle d-flex align-items-center justify-content-center
            ...
            {{-- Net Balance --}}
            <div class="col-md-4 mb-4">
                <div class="card h-100 d-flex flex-column justify-content-center {{ $netIncome < 0 ? 'transaksi-net-negative' : '' }}"
                    {{ $netIncome < 0 ? 'role=alert aria-live=polite' : '' }}>
                    <div class="card-body py-4">
                        <div class="d-flex align-items-center">
                            <div
                                class="card-icon transaksi-card-icon {{ $netIncome >= 0 ? 'transaksi-card-icon--primary bg-primary-light text-primary' : 'transaksi-card-icon--warning bg-danger-light text-danger' }}
                                        rounded-circle d-flex align-items-center justify-content-center
                                        me-3">
                                <i
                                    class="bi {{ $netIncome >= 0 ? 'bi-wallet2' : 'bi-exclamation-triangle-fill' }} fs-3"></i>
                            </div>
                            <div>
                                <h6 class="text-muted small text-uppercase mb-1 fw-bold">
                                    {{ __('Net Balance') }}
                ...
                <div class="card">
                    <div class="card-body py-3">
                        <div class="d-flex flex-column align-items-start text-start">
                            ...
                            <span
                                class="badge bg-light text-secondary border fw-normal  px-2 py-1 mb-2
                                ...
                                <div class="toolbar-actions d-none d-lg-flex align-items-center gap-2">
                                    ...
                                    <div class="dropdown">
                                        <button
                                            ...
                                            aria-expanded="false" title="{{ __('Actions') }}">
                                        ...
                                        <ul class="dropdown-menu shadow border-0 rounded-3">
                                            <li>
                                                <button class="dropdown-item" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#filterCollapse" aria-controls="filterCollapse">
                                ...
                                <div class="toolbar-quick-dates">
                                    ...
                                    @foreach ($shortcuts as $label => $range)
                                        <a href="{{ route('transaksi.index', array_merge($baseQuery, $range)) }}"
                                            class="btn btn-outline-secondary btn-xs " title="{{ $label }}">
                                            {{ $label }}
                                        </a>
                                    @endforeach
                                </div>
                                ...
                                <div class="toolbar-mobile-actions d-flex d-lg-none align-items-center gap-2 ms-auto">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3">
                                            ...
                                            <li>
                                                <a class="dropdown-item no-loader" id="btnExportExcelMobile"
                                                    href="{{ route('transaksi.export.excel', request()->all()) }}">
                                                    <i class="bi bi-file-earmark-excel me-2 text-success"></i> Excel
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item no-loader" id="btnExportPdfMobile"
                                                    href="{{ route('transaksi.export.pdf', request()->all()) }}">
                                                    <i class="bi bi-file-earmark-pdf me-2 text-danger"></i> PDF
                                                </a>
                                            </li>
                            ...
                            <div class="card card-body bg-light border-0 p-4 rounded-4">
                                <form method="GET" class="row g-3">
                                    ...
                                    <div class="col-12 d-flex justify-content-end gap-2 mt-3">
                                        ...
                                        <button type="button" id="btnApplyFilter" class="btn btn-primary btn-sm  px-4">
                                            {{ __('Apply Filter') }}
                                        </button>
                                    </div>
