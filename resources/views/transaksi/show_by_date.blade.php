...
@push('css')
    <style>
        ...
        [data-bs-theme="dark"] .tx-row {
            background: #1a1a1a;
            border-color: rgba(255, 255, 255, 0.05);
        }

        [data-bs-theme="dark"] .tx-row:hover {
...
@section('container')
            ...
            <div>
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('transaksi.index') }}">{{ __('Transactions') }}</a>
                        </li>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted small mb-0 mt-1">{{ $transaksi->count() }}
                                {{ __('records on this date') }}</p>
                        </div>
                    </div>
                                ...
                                @foreach ($transaksi as $t)
                                    ...
                                    <div class="tx-row d-flex align-items-center gap-3">
                                        ...
                                        <div class="flex-grow-1 min-w-0">
                                            ...
                                            @endif
                                            @if ($t->dompet)
                                                <span class="badge bg-light text-secondary border fw-normal px-2 py-0 mt-1"
    ...
    {{-- FAB Mobile --}}
    <a href="{{ route('transaksi.create', ['date' => $date]) }}" class="btn btn-primary fab-add"
