...
<body>
    ...
    <p>Total Pendapatan: Rp {{ number_format((float)$totalPemasukan,0,',','.') }}</p>
    <p>Total Pengeluaran: Rp {{ number_format((float)$totalPengeluaran,0,',','.') }}</p>
    <p>Laba Bersih: Rp {{ number_format((float)$netIncome,0,',','.') }}</p>
