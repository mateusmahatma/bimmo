    ...
    <div class="threads-page">
        ...
        <div class="pagetitle mb-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <button class="btn btn-primary px-4" data-bs-toggle="modal" data-bs-target="#addThreadModal">
                ...
                <div class="modal-content">
                    <div class="modal-header pb-0">
                        <h5 class="modal-title fw-bold"><i
                                class="bi bi-pencil-square me-2 text-primary"></i>{{ __('Thread Baru') }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title"
                                    ...
                                    placeholder="{{ __('Tulis judul thread yang menarik...') }}" value="{{ old('title') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="body" id="body" rows="4"
                                    ...
                                    placeholder="{{ __('Ceritakan sesuatu, tanya, atau berbagi tips keuangan...') }}" maxlength="5000" required>{{ old('body') }}</textarea>
                                @error('body')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="text-center py-5">
                <div class="mb-3">
                    <i class="bi bi-chat-square-dots"
                        style="font-size: 4rem; color: var(--bs-secondary-color); opacity: 0.4;"></i>
                </div>
                <h6 class="text-muted">{{ __('Belum ada thread.') }}</h6>
                <p class="text-muted small">{{ __('Jadilah yang pertama memulai diskusi!') }}</p>
                <button class="btn btn-primary btn-sm px-4 mt-1" data-bs-toggle="modal" data-bs-target="#addThreadModal">
                                        ...
                                        <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                                            ...
                                            @if (Auth::id() === $thread->id_user)
                                                <span class="badge bg-primary-subtle text-primary rounded-pill"
                                                    style="font-size: 0.65rem;">{{ __('Anda') }}</span>
                                            @endif
                                        </div>
                                        <h6 class="fw-bold mb-1 text-body thread-title">{{ $thread->title }}</h6>
                                        <p class="text-muted mb-2 small thread-body-preview">
                                            {{ Str::limit($thread->body, 120) }}</p>
