(function () {
    ...
    function initTransaksiIndexPage() {
        ...
        var tableContainer = document.getElementById('transaction-table-container');
        ...
        if (btnResetFilter) {
            btnResetFilter.addEventListener('click', function (e) {
                ...
                if (typeof jQuery !== 'undefined') {
                    var $lbl = jQuery('#transaksiDaterange .transaksi-daterange-label');
                    if ($lbl.length) $lbl.text('—');
                    var picker = jQuery('#transaksiDaterange').data('daterangepicker');
            ...
            fetch(urlObj.toString(), {
                ...
                .then(function (data) {
                    ...
                    if (data.modal_pemasukan) {
                        var incomeBody = document.getElementById('income-modal-body');
                        if (incomeBody) incomeBody.innerHTML = data.modal_pemasukan;
                    }
                    if (data.modal_pengeluaran) {
                        var expenseBody = document.getElementById('expense-modal-body');
        ...
        function updateSummaryCards(stats) {
            ...
            if (cardIncome) {
                ...
                if (h4) {
                    h4.textContent =
                        'Rp ' +
                        new Intl.NumberFormat('id-ID').format(stats.totalPemasukan);
                }
            }
            ...
            if (cardExpense) {
                ...
                if (h4e) {
                    h4e.textContent =
                        'Rp ' +
                        new Intl.NumberFormat('id-ID').format(stats.totalPengeluaran);
                }
            }
            ...
            if (dailyEl && stats.avgDailyPengeluaran !== undefined) {
                dailyEl.textContent =
                    'Rp ' +
                    new Intl.NumberFormat('id-ID').format(stats.avgDailyPengeluaran);
            }
        ...
        var btnConfirmExportEmail = document.getElementById('btnConfirmExportEmail');
        if (btnConfirmExportEmail) {
            btnConfirmExportEmail.addEventListener('click', function () {
                var recipientEmail = document.getElementById('export_recipient_email');
